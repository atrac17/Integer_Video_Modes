...
<details>
 ...
 <summary>Console Core Video Modes</summary>

## <summary1><b>MiSTer.ini Information</b></summary1>
   
- The default resoltion for you `MiSTer.ini` should always be **720p**. This can be set by adjusting `video_mode=` to `0`.
- Unless stated below, the `MiSTer.ini` settings will always be `vscale_mode=1` and `vsync_adjust=2`.
...
|Primary Modelines NTSC (320x224)|Core|Resolution (Visible)|Resolution (Scaled)|Integer (Scaled)|Resolution (Vert.)|Resolution (Hor.)|
|--|--|--|--|--|--|--|
...
|Secondary Modelines NTSC (256x224)|Core|Resolution (Visible)|Resolution (Scaled)|Integer (Scaled)|Resolution (Vert.)|Resolution (Hor.)|
|--|--|--|--|--|--|--|
...
|Primary Modelines NTSC (256x224)|FPGA Core|Resolution (Visible)|Resolution (Scaled)|Integer (Scaled)|Resolution (Vert.)|Resolution (Hor.)|
|--|--|--|--|--|--|--|
...
|Secondary Modelines NTSC (256x240)|FPGA Core|Resolution (Visible)|Resolution (Scaled)|Integer (Scaled)|Resolution (Vert.)|Resolution (Hor.)| 
|--|--|--|--|--|--|--|
